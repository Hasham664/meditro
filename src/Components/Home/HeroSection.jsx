    ...
    <>
      <div className=" Mycontainer  flex flex-col items-center gap-6 lg:flex-row lg:justify-between   ">
        <div className=" space-y-4">
          ...
          <button className="z-10 relative mt-12 flex items-center gap-1 text-2xl  cursor-pointer px-6 py-3 bg-gradient-to-r from-custom-blue to-custom-teal text-white rounded-md ">
            Book an appointment
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-4 z-10 relative">
              {[
                ...
                <div key={index}>
                  <Image className="	" src={hero.icon} alt="hero" width={50} />
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="relative mb-12  inset-0  ">
        <Image
          src={dottedLine}
          alt="Dotted Line"
